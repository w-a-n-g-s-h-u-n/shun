package org.wangshun.shun.web.config.swagger;
...
public class SwaggerAutoConfiguration {
    ...
    private List<SecurityReference> defaultAuth() {
        ...
        return Collections.singletonList(SecurityReference.builder().reference(swaggerProperties().getAuthorization().getName()).scopes(authorizationScopeList.toArray(authorizationScopes)).build());
    }
