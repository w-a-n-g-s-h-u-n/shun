...
public class IpUtils {
     ...
     * @return
     */
    public static HashMap<String, String> getAreaByIp(HttpServletRequest request) {
                    ...
                    if (!StringUtils.isEmpty(result)) {
                        ...
                        if (jsonResult != null) {
                            if (jsonResult.get("errNum")!=null&&Integer.parseInt(jsonResult.get("errNum").toString())<1&&jsonResult.get("errMsg")!=null&&("SUCCESS".equalsIgnoreCase(jsonResult.get("errMsg").toString()) || "SUCCESS".equalsIgnoreCase(jsonResult.get("retMsg").toString()))) {
                                mapData = (HashMap<String, String>) jsonResult.get("retData");
                            } else {
     ...
     * @return
     */
    private static HashMap<String, String> getAreaByTaoBaoIp(HttpServletRequest request) {
        HashMap<String, String> mapData = null;
        if ("prod".equalsIgnoreCase(SpringUtils.getCtxEnvironment())){
                    ...
                    if (!StringUtils.isEmpty(result)) {
                        ...
                        if (jsonResult != null) {
                            if ("0".equals(jsonResult.get("code").toString())) {
                                mapData = (HashMap<String, String>) jsonResult.get("data");
                            } else {
                                mapData = null;
